                ...
                <div className="container mx-auto px-4">
                  <div className="home-wrapper">
                    <div className="flex flex-col home-container">
                      <div>
                        <h2 className="home-title text-xl font-bold mb-4 ps-10 py-4 text-white">Who We Are</h2>
                        <h1 className="font-bold text-[40px] leading-tight">Take Your Health And Body To Next Level</h1>
                        <p className="py-2">Take your health and body to the next level with our comprehensive program designed to help you reach your fitness goals.</p>
                      </div>
                      <div className="home-detail grid md:grid-cols-2 lg:grid-cols-3  gap-4 my-5">
                        <div className="detail">
                          ...
                          <h1 className="font-bold text-[20px] py-2">PROFESSIONAL TRAINERS</h1>
                        </div>
                        <div className="detail">
                          ...
                          <h1 className="font-bold text-[20px] py-2">MODERN EQUIPMENTS</h1>
                        </div>
                        <div className="detail">
                          ...
                          <h1 className="font-bold text-[20px] py-2">FANCY GYM MACHINES</h1>
                        </div>
                      </div>
                      <br />
