...
//                             <Link onClick={closeLinks} className="head-link" href="/">Home</Link>
//                             <Link onClick={closeLinks} className="head-link" href="/classes">Classes</Link>
//                             <Link onClick={closeLinks} className="head-link" href="/schedule">Schedule</Link>

//                             {user ? (
//                                 <>
//                                     <Link onClick={closeLinks} className="head-link" href="/profile">Profile</Link>
//                                     <button onClick={handleSignOut} className="text-yellow-500 ml-4 font-extrabold">Sign Out</button>
//                                 </>
//                             ) : (
//                                 <>
//                                     <Link onClick={closeLinks} className="head-link" href="/about">About Us</Link>
//                                     <Link onClick={closeLinks} className="head-link" href="/register">Register</Link>
//                                 </>
//                             )}
//                         </div>
...
//                             <Link className="head-link" href="/classes">Classes</Link>
//                             <Link className="head-link" href="/schedule">Schedule</Link>

//                             {user ? (
//                                 <>
//                                     <Link className="head-link" href="/profile">Profile</Link>
//                                     <button onClick={handleSignOut} className="text-yellow-500 ml-4 font-extrabold">Sign Out</button>
//                                 </>
//                             ) : (
//                                 <>
//                                     <Link className="head-link" href="/about">About Us</Link>
//                                     <Link className="head-link" href="/register">Register</Link>
//                                 </>
//                             )}
//                         </nav>
            ...
            <div className="navleft" id={openLinks ? 'open' : 'close'}>
              ...
              {user ? (
                <>
                  ...
                  <button onClick={handleSignOut} className="text-yellow-500 ml-4 font-extrabold">
                    Sign Out
                  </button>
                </>
              ) : (
